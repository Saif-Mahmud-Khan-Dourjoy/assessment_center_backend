...
class CreateUserAcademicHistoriesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('user_academic_histories', function (Blueprint $table) {
            ...
            $table->string('exam_course_title', 250);
            $table->string('major',200)->default('general')->comment('Default field is general, but it could be Science, Arts, Business, Madrasha, Diploma etc');
