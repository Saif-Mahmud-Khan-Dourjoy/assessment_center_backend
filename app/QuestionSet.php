...
class QuestionSet extends Model
{
     ...
     */
    protected $fillable = [
        'title', 'type', 'institute_id', 'institute', 'assessment_time', 'start_time', 'end_time' , 'each_question_time' , 'total_question', 'total_mark', 'status', 'privacy', 'approved_by',  'round_id','created_by', 'updated_by'
    ];
